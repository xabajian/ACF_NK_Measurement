...
*============================================================*
* Country-level data out for simulations, early sample
*============================================================*
...
save "$processed/CWON_data_early.dta", replace
save "$root/simulations/CWON_data_early.dta", replace
...
*============================================================*
* Country-level data out for simulations, late sample
*============================================================*
...
tostring country_byte, gen(country_string)
save "$processed/CWON_data_late.dta", replace
save "$root/simulations/CWON_data_late.dta", replace
restore
