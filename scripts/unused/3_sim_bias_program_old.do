...
version 12.1
syntax [,  number_periods(integer 70) corr_N1_K(real 0.01) corr_N1_N2(real 0.01)  gn1(real 0.01)  gn2(real 0.01)   gK(real 0.01) sdK(real 0.01) sdA(real 0.01) sdn1(real 0.01) sdn2(real 0.01) gA(real 0.01) ] 
...
//make first bias term (two omitted stocks) 
...
//make second bias term (one omitted stocks) 
...
return scalar MSE_NK_out = MSE_NK
return scalar MSE_1K_out = MSE_1K
return scalar reduction_share = (MSE_NK-MSE_1K)/MSE_NK
...
quietly {
    forvalues i = 1/`r(N)' {
        ...
        * Run your program (example)
		solve_bias_variance, number_periods(70) corr_N1_K(`corr_N1_K_in') corr_N1_N2(`corr_N1_N2_in')  gn1(`g1_in')  gn2(`g2_in')  gK(`gk_in') sdK(`sdK_in') sdA(`sdA_in') sdn1(`sd1_in') sdn2(`sd2_in') gA(`ga_in') 
