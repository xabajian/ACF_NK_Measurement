...
qui {
    ...
    */
    ...
    //gen log levels
    local outcomes ag_NK fisheries rec_forests FWE Hydro Mangroves NFS Timber 
...
preserve
keep countrycode year ag_NK fisheries rec_forests FWE Hydro Mangroves NFS Timber 
